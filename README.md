...
da API pública do Governo Federal. A versão 0.1.0 é limitada ao catálogo de
...
A [matriz de Materiais](docs/endpoints/matriz-material-0.1.0.md) registra os
...
- Endpoints adiados não fazem parte da interface estável da versão 0.1.0.
